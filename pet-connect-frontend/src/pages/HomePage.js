    ...
    <div className="home-page">
      <div className="hero-section">
        <div className="hero-content">
          <h1>Find Your Perfect Animal Companion</h1>
          <p>
            Our AI-powered recommendation system helps match you with animals
            that fit your lifestyle and preferences.
          </p>
          <div className="hero-buttons">
            <Link to="/recommendations" className="primary-button">
        ...
        <div className="how-it-works-steps">
          <div className="step">
            ...
            <p>Sign up and set your preferences for the type of animal you're looking for.</p>
          </div>
          
          <div className="step">
            <div className="step-number">2</div>
            <h3>Browse Animals</h3>
            <p>Explore animals from local shelters and view their profiles.</p>
          </div>
          
          <div className="step">
            <div className="step-number">3</div>
            <h3>Get Personalized Recommendations</h3>
            <p>Our AI analyzes your preferences and browsing behavior to suggest compatible matches.</p>
          </div>
          
          <div className="step">
            <div className="step-number">4</div>
            <h3>Connect with Shelters</h3>
            <p>Once you find a potential match, contact the shelter to arrange a meeting.</p>
          </div>
        </div>
      </div>
